...
- 생성형 AI와 LLM(대규모 언어 모델)의 핵심 개념을 자신의 언어로 설명할 수 있습니다.
...
- **생성형 AI (Generative AI):** 기존 데이터를 학습하여 **세상에 없던 새로운 콘텐츠(텍스트, 이미지, 코드 등)를 생성**하는 인공지능의 한 분야입니다.
- **LLM (Large Language Model):** 생성형 AI를 구현하는 엔진의 한 종류로, **'다음에 올 단어를 가장 확률 높게 예측하는 정교한 프로그램'**이라고 할 수 있습니다.
